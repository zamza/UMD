...
function StateMan(){
	...
	this.addState = function(name, callBack){
		var tState = new State(name, callBack);
...
function Meter(scene, max, meterX, meterY, col, w, h, dir, imgsrc, imgX, imgY){
	...
	this.draw = function(){
		...
		var maxX = this.meterTopLeftX + this.camera.cameraOffsetX + this.width;
		var maxY = this.meterTopLeftY + this.camera.cameraOffsetY + this.height;
		var w = this.width;
		var h = this.height;
...
function Scene(placementId){
    ...
    */
	...
	this.addState = function(name, callb){ return this.stateMan.addState(name, callb); }
